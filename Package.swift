...
let package = Package(name: "opentelemetry-swift",
                      ...
                      products: [
                        ...
                        .library(name: "OpenTelemetryDataCompression", type: .static, targets: ["OpenTelemetryDataCompression"]),
                      ...
                      targets: [
                        ...
                        .target(name: "OpenTelemetryDataCompression",
                                dependencies: [],
                        ...
                        .target(name: "BaggagePropagationProcessor",
                                dependencies: ["OpenTelemetryApi",
                                               "OpenTelemetrySdk"],
                        ...
                        .testTarget(name: "ContribTests",
                                    dependencies: ["BaggagePropagationProcessor",
                                                   "InMemoryExporter"]),
                        .executableTarget(name: "LoggingTracer",
                                          dependencies: ["OpenTelemetryApi"],
                                          path: "Examples/Logging Tracer"),
                        .executableTarget(name: "LogsSample",
  ...
  func addPlatformSpecific() -> Self {
      ...
      targets.append(contentsOf: [
        ...
        .executableTarget(name: "OTLPHTTPExporter",
                          dependencies: ["OpenTelemetrySdk", "OpenTelemetryProtocolExporterHttp", "StdoutExporter", "ZipkinExporter", "ResourceExtension", "SignPostIntegration", "OpenTelemetryDataCompression"],
