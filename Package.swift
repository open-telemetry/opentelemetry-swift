...
let package = Package(
    ...
    targets: [
        ...
        .target( name: "DatadogExporter", dependencies: ["OpenTelemetrySdk"], path: "Sources/Exporters/DatadogExporter"),
        .testTarget(name: "DatadogExporterTests", dependencies: ["DatadogExporter", "NIO", "NIOHTTP1"], path: "Tests/ExportersTests/DatadogExporter"),
