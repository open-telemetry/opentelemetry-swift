...
struct Opentelemetry_Proto_Collector_Metrics_V1_ExportMetricsServiceResponse {
  ...
  var partialSuccess: Opentelemetry_Proto_Collector_Metrics_V1_ExportMetricsPartialSuccess {
...
struct Opentelemetry_Proto_Collector_Metrics_V1_ExportMetricsPartialSuccess {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var rejectedDataPoints: Int64 = 0
...
extension Opentelemetry_Proto_Collector_Metrics_V1_ExportMetricsPartialSuccess: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ExportMetricsPartialSuccess"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Opentelemetry_Proto_Collector_Metrics_V1_ExportMetricsPartialSuccess, rhs: Opentelemetry_Proto_Collector_Metrics_V1_ExportMetricsPartialSuccess) -> Bool {
