...
//
/////  A scope that manages the context for a Baggage.
//class BaggageInScope: Scope {
////    var current = os_activity_scope_state_s()
//
//    /// Constructs a new BaggageInScope.
//    /// - Parameter baggage: the Baggage to be added to the current context.
...
////        //OpenTelemetryContextProvider.setContext(activityId: activityId, forBaggage: baggage)
//    }
//
//    func close() {
