...
public protocol RawHistogramMetric {
    ...
    ///     - labelset: The labelset from which bound instrument should be constructed.
    func record(explicitBoundaries: [T],
                counts: [Int],
                startDate: Date,
                endDate: Date,
                count: Int,
...
public struct AnyRawHistogramMetric<T>: RawHistogramMetric {
    ...
    public func record(explicitBoundaries: [T],
                       counts: [Int],
                       startDate: Date,
                       endDate: Date,
                       count: Int,
...
public struct NoopRawHistogramMetric<T>: RawHistogramMetric {
    public func record(explicitBoundaries: [T], counts: [Int], startDate: Date, endDate: Date, count: Int, sum: T, labelset: LabelSet) {

    }

    public func record(explicitBoundaries: [T], counts: [Int], startDate: Date, endDate: Date, count: Int, sum: T, labels: [String: String]) {
