...
final class OtlpTraceJsonExporterTests: XCTestCase {
    ...
    func testGetExportedSpans() {
        ...
        let firstSpan = spans[0].resourceSpans?[0].instrumentationScopeSpans?[0].spans
        XCTAssertEqual(firstSpan?[0].name, "one")
        
        let secondSpan = spans[1].resourceSpans?[0].instrumentationScopeSpans?[0].spans
        XCTAssertEqual(secondSpan?[0].name, "two")
        
        let thirdSpan = spans[2].resourceSpans?[0].instrumentationScopeSpans?[0].spans
